...
typedef enum {BF_FILE, HP_FILE, HT_FILE, SHT_FILE, NONE} FILE_TYPE;
...
typedef struct {
    ...
    int max_records;            // Ο αριθμός των εγγραφών που χωράνε σε κάθε BF_Block
} HT_info;

typedef struct {
    int num_of_records;         // Ο αριθμός των εγγραφών στο συγκεκριμένο block
